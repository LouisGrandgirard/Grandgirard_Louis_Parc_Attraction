...
def add_attraction(data, author_id):
    ...
    if ("attraction_id" in data and data["attraction_id"]):
      ...
      requete = "INSERT INTO attraction (nom, description, difficulte, visible, author_id) VALUES (?, ?, ?, ?, ?);"
      id = req.insert_in_db(requete, (data["nom"], data["description"], data["difficulte"], data["visible"], author_id))
